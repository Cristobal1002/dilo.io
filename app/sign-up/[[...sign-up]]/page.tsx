...
import { isPortalContextRedirect, resolvePostSignUpUrl } from '@/lib/auth-redirect'
...
export default async function SignUpPage({ searchParams }: Props) {
  ...
  const fallbackRedirectUrl = resolvePostSignUpUrl(redirectUrl)
  ...
  return (
    <AuthPageShell
      tagline={
        portalFlow
          ? 'Accede al portal de soporte de tu empresa.'
